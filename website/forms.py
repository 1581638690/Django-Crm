...
class SignUpForm(UserCreationForm):
    email=forms.EmailField(label="",widget=forms.TextInput(attrs={"class":"form-control",'placeholder':"Emaill Adresss"}))
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields["username"].help_text='<span class="form-text text-myted"><small>Required,150characters of fewer.Letters, digits and @/./+/-/_ only.</small></span>'
